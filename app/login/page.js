...
const Login = () => {
    ...
    return (
        <div className='text-white py-14 container mx-auto'>
            <h1 className='font-bold text-center text-3xl'>Login to get your fans support you</h1>

            <div className="flex flex-col gap-2 min-h-screen items-center p-10">


                <button
                    className="flex items-center w-60 cursor-pointer bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                ...
                <button
                    className="flex items-center w-60 cursor-pointer bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" onClick={() => { signIn("github") }}>
                    <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
